...
def DYN_EARTH_plot(timeline, DYN_obj, SEN_obj):
    # Earth state
...
def DYN_MARS_plot(timeline, DYN_obj, SEN_obj):
    # Mars state
...
def DYN_GRV_plot(timeline, DYN_obj, SEN_obj):
...
def DYN_TRA_plot(timeline, DYN_obj, SEN_obj):
    # 3D trajectories
...
def DYN_ATT_plot(timeline, DYN_obj, SEN_obj):
    # Spacecraft attitude
...
def DYN_STR_plot(timeline, DYN_obj, SEN_obj):
...
def SEN_STR_plot(timeline, DYN_obj, SEN_obj):
