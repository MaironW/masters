...
los_angle_max = 90*CONSTANTS_par["deg2rad_cst"] # [rad] Maximum angle between body and star to be considered valid
...
NAV_CEL_par = {
    ...
    "sigma_angle"       : 1e-5,              # [rad] STR noise std in [X,Y,Z] directions
    ...
    "time_valid_ini"          : 0                   # [s] initial time_STR output for valid measurements
}
